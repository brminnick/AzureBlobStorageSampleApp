# XamarinBlobStorageSampleApp

A simple Xamarin.Forms app that displays an image from Azure Blob Storage. It is a single-page app that communicates directly with our Azure Blob Storage Container using the [Azure Storage SDK for .NET](https://docs.microsoft.com/dotnet/api/overview/azure/storage/?WT.mc_id=none-github-bramin).
...
![Xamarin Blob Storage Sample App Diagram](https://blog.xamarin.com/wp-content/uploads/2018/03/XamarinBlobStorageSampleAppDiagram.png)
